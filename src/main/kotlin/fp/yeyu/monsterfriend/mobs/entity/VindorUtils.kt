...
object VindorUtils {
    ...
    fun forceInvoke(@Suppress("UNUSED_PARAMETER") befriendMinecraft: BefriendMinecraft) {}

    private fun getFile(filename: String): File {
        val parent = Paths.get(".").resolve("mods").resolve(BefriendMinecraft::class.simpleName!!).resolve("wonder_trade").toFile()
        if (!parent.exists()) {
            parent.mkdirs()
        }
